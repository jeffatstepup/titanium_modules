...
/** 
 * This is a copy of the TiUIScrollView with extensions to add the listener interface to the native scroll view.
 * 
 */

public class TandemScrollView extends TiUIView
{
	...
	private class TiVerticalScrollView extends ScrollView implements TandemListener
	{
	...
	private class TiHorizontalScrollView extends HorizontalScrollView implements TandemListener
	{
		private TiScrollViewLayout layout;
	...
	public TandemScrollView(TiViewProxy proxy)
	{
